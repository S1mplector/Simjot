...
public class JournalApp extends JFrame {
    ...
    public JournalApp() {
        ...
        setIconImage(ResourceLoader.createImage("Simjournal/img/feather.png"));
    ...
    private JPanel createMainMenuPanel() {
        ...
        if(bgPath != null && !bgPath.isEmpty()) {
            if(bgPath.startsWith("res:")){
                ...
                java.awt.Image img = ResourceLoader.createImage("Simjournal/"+resPath);
    ...
    private void showTutorialIfFirstTime() {
        ...
        if(!store.isTutorialSeen()) {
            boolean yes = CustomConfirmDialog.confirm(this, "Quick Tour", "Would you like a quick tour of Simjournal's features?");
            if(yes) {
