...
public class DrawingPanel extends JPanel {
    ...
    private void saveDrawingAsCustomFile() {
        // Auto-save into the dedicated drawings directory inside the Simnote root
    ...
    private static class IconButton extends JButton {
        ...
        public IconButton(String iconPath) {
            ...
            if (!forceVector) {
                ...
                this.icon = ResourceLoader.createImageIcon(iconPath.startsWith("Simjournal/") ? iconPath.substring("Simjournal/".length()) : iconPath);
                if (this.icon != null) {
                    setIcon(this.icon);
                }
            } else {
