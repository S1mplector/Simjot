 ...
 * Simnote root folder should live.  After the user picks a location we create
...
public class SetupWizardDialog extends JDialog {
    ...
    public SetupWizardDialog(JFrame owner) {
        super(owner, "Simjournal – First-time setup", true);
        initUI();
    }
    ...
    private void initUI() {
        ...
        JLabel title = new JLabel("Welcome to Simjournal!", JLabel.CENTER);
        title.setFont(title.getFont().deriveFont(Font.BOLD, 18f));
        title.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel desc = new JLabel("Choose where you would like to store your Simnote files.");
        ...
        chooseBtn.addActionListener(e -> {
            ...
            if (chosen != null) {
                rootFolder = new File(chosen, "Simnote");
        ...
        docsBtn.addActionListener(e -> {
            ...
            rootFolder = new File(documentsPath, "Simnote");
            SwingUtilities.invokeLater(() -> performInitialSetup(spinner));
        });
    ...
    private void performInitialSetup(ModernSpinner spinner) {
        ...
        if (System.getProperty("os.name").toLowerCase().contains("win")) {
            boolean yes = CustomConfirmDialog.confirm(this, "Create Shortcut", "Would you like a Simjournal shortcut on your Desktop?");
            if(yes){
                try{
    ...
    private void createDesktopShortcut() throws Exception {
        ...
        // If we are running from a jpackage installation "Simjournal.exe" might be in same dir.
        // Otherwise point to the jar.
        String desktopPath = System.getProperty("user.home") + File.separator + "Desktop";
        File shortcut = new File(desktopPath, "Simjournal.url");
    ...
    private static class WallpaperChooser extends JDialog {
        ...
        WallpaperChooser(Dialog owner){
            ...
            for(String res : BUILTIN){
                Image img = ResourceLoader.createImage("Simjournal/"+res);
